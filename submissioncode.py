...
!git clone https://github.com/uchieduca/dl_lecture_competition_pub.git
...
!unzip "/content/drive/MyDrive/Colab Notebooks/DLBasics2023_colab/最終課題/data/train.zip"
!unzip "/content/drive/MyDrive/Colab Notebooks/DLBasics2023_colab/最終課題/data/valid.zip"
